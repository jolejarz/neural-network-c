...
all: xor seven-segment_display seven-segment_display_mb LeNet5 LeNet5_omp LeNet5_sgd bit_delay
...
seven-segment_display_mb: seven-segment_display_mb.c annl.o
	${CC} -o seven-segment_display_mb seven-segment_display_mb.c annl.o ${end}
...
LeNet5_sgd: LeNet5_sgd.c annl.o
	${CC} -o LeNet5_sgd LeNet5_sgd.c annl.o ${end}
